...
<body>
	<header>
		<nav>
			<ul class="nav-list">
				<li><a class="nav-link" href="/admin/autor">Cadastro de Autores</a></li>
				<li><a class="nav-link" href="/admin/listautor">Lista de Autores</a></li>
			</ul>
		</nav>
	</header>
		...
		<div class="card">
			...
			<form:form action="${s:mvcUrl('AC#updateAutor').build()}" method="POST"
				...
				<div class="div1">
					...
					<form:input class="form-control" path="nome" value="${autorEdit.nome}" />
				</div>
				<div>
